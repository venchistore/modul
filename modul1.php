...
class Display {
	...
	static function Ban($title, $versi, $server = 0){
		...
		print o2."    / ____/   | / / / / ____/ ____/_  __/\n";
		print o."  / /_  / /| |/ / / / /   / __/   / /\n";
		print y." / __/ / ___ / /_/ / /___/ /___  / /\n";
		print y."/_/   /_/  |_\____/\____/_____/ /_/\n";
		print p." Special Tanks to \n";
		print str_pad("@PetapaGenit2, @IEWIL OFFICIAL, @Zhy_08, @IPeop", 44, " ", STR_PAD_BOTH).n;
